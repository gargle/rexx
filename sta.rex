...
rc = SockGetHostByName("tpad.bs2000.netpost","host.!")
if (rc = 0) then
do
...
call BS2000_send_receive "MODIFY-TERMINAL-OPTIONS OVERFLOW=*NO-CONTROL"
call BS2000_send_receive "STA L"
call BS2000_send_receive "STA P"

logout:

call BS2000_send_receive "LOGOFF NOSPOOL"
...
BS2000_send_receive: procedure expose sock ,
                                     C. ,
                                     G. ,
                                     F.
parse arg command
call BS2000_send command,1 
call BS2000_receive_until_prompt 'nop',1
return 0
